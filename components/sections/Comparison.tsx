        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <ScrollReveal animation="scale-up" delay={0.4}>
              <Card className="relative border-2 border-accent shadow-lg h-full transform scale-105 md:scale-105 z-10">
                <div className="absolute -top-3 left-4">
                ...
                <div className="text-center pt-4 border-t border-accent/30 mt-auto">
